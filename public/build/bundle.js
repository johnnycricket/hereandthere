    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			span0 = element("span");
    			t0 = text(/*theClock*/ ctx[1]);
    			t1 = space();
    			span1 = element("span");
    			t2 = text(/*place*/ ctx[0]);
    			attr(span0, "data-testid", "clock");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*theClock*/ 2) set_data(t0, /*theClock*/ ctx[1]);
    			if (dirty & /*place*/ 1) set_data(t2, /*place*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			header.innerHTML = `<h1>There and Here</h1>`;
    			t1 = space();
    			main = element("main");
